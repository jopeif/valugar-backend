/*
  ...
  - The values [RESIDENTIAL] on the enum `PropertyCategory` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "PropertyCategory_new" AS ENUM ('RESIDENCIAL', 'COMMERCIAL', 'MIXED_USE');
